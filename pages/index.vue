    ...
    <div class="container-fluid browsing-history">
      <div class="row">
        <div class="col-sm-8 col-8">
          ...
          <!-- Buttons -->
          <nuxt-link to="/products" class="a-button-history margin-10">Add a new product</nuxt-link>
          <nuxt-link to="/category" class="a-button-history margin-10">Add a new category</nuxt-link>
          <nuxt-link to="/owner" class="a-button-history margin-10">Add a new owner</nuxt-link>
        </div>
...
<script>
export default {
  // asyncData is fetching data before nuxt page finished loading on browser
